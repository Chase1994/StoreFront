...
namespace StoreFront
{
    ...
    public partial class StoreFrontDBEntities : DbContext
    {
        ...
        public virtual int spAddProduct(string productName, string productDescription, Nullable<bool> isPublished, Nullable<decimal> price)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("spAddProduct", productNameParameter, productDescriptionParameter, isPublishedParameter, priceParameter);
        }
        ...
        public virtual ObjectResult<Nullable<int>> spGetShoppingCart(Nullable<int> userID)
        {
            var userIDParameter = userID.HasValue ?
                new ObjectParameter("UserID", userID) :
                new ObjectParameter("UserID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<int>>("spGetShoppingCart", userIDParameter);
        }
        ...
        public virtual int spUpdateProduct(Nullable<int> productID, string productName, string productDescription, Nullable<bool> isPublished, Nullable<decimal> price)
        {
            var productIDParameter = productID.HasValue ?
                new ObjectParameter("ProductID", productID) :
                new ObjectParameter("ProductID", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("spUpdateProduct", productIDParameter, productNameParameter, productDescriptionParameter, isPublishedParameter, priceParameter);
        }
